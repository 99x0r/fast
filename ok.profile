...
## MS IE 11 User Agent
set useragent "Mozilla/5.0 (Windows NT 9.3; Trident/7.0; rv:11.0) like Gecko";
...
set host_stage "true"; # Do not use staging. Must use stageles payloads, now the default for Cobalt Strike built-in processes
...
#obfuscate true                                  
#CS 3.14 - Scrambles the content of the post-ex DLLs and settles the post-ex capability into memory in a more OPSEC-safe way
...
#smartinject   true                                   #CS 3.14 added to postex block - Directs Beacon to embed key function pointers, like GetProcAddress and LoadLibrary, into its same-architecture post-ex DLLs.
